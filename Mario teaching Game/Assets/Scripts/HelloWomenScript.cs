...
public class HelloWomenScript : MonoBehaviour
{
    ...
    private IEnumerator FetchQuestionData()
    {
        ...
        if (this.userLevel == 1)
        {
            ...
            {
                yield return StartCoroutine(firebaseManager.GetQuestionData("question_1_es", OnQuestionDataReceived));
            }
        }
        else if (this.userLevel == 2)
        {
            ...
            {
                yield return StartCoroutine(firebaseManager.GetQuestionData("question_1_level_2_es", OnQuestionDataReceived));
            }
        }
    }
